...
server.register(fastifyCors, {
    origin: ['http://localhost', 'http://localhost:8080/graphql', 'http://localhost:8080', 'https://prytaneum-dev-wnse2xo3ka-uc.a.run.app', 'https://prytaneum-dev-wnse2xo3ka-uc.a.run.app/graphql'],
