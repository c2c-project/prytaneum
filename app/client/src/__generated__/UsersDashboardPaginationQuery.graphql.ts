...
export type UsersDashboardPaginationQuery$variables = {
  after?: string | null;
  filter?: UsersSearchFilters | null;
  first?: number | null;
  id: string;
};
...
return {
  "fragment": {
    ...
    "kind": "Fragment",
    "metadata": null,
    "name": "UsersDashboardPaginationQuery",
    "selections": [
      {
        "alias": null,
        "args": (v1/*: any*/),
  ...
  "params": {
    "cacheID": "d4e64603be70033430e5e248f74e32e1",
    "id": null,
    "metadata": {},
    "name": "UsersDashboardPaginationQuery",
    "operationKind": "query",
    "text": "query UsersDashboardPaginationQuery(\n  $after: String = \"\"\n  $filter: UsersSearchFilters = {firstName: \"\", lastName: \"\", email: \"\"}\n  $first: Int = 200\n  $id: ID!\n) {\n  node(id: $id) {\n    __typename\n    ...useUsersDashboardFragment_G9cLv\n    id\n  }\n}\n\nfragment useUsersDashboardFragment_G9cLv on User {\n  users(first: $first, after: $after, filter: $filter) {\n    edges {\n      node {\n        id\n        firstName\n        lastName\n        email\n        avatar\n        isAdmin\n        canMakeOrgs\n        __typename\n      }\n      cursor\n    }\n    pageInfo {\n      endCursor\n      hasNextPage\n    }\n  }\n  id\n}\n"
  }
};
})();

(node as any).hash = "3f0fea87f37066b7f8df893ed2afe699";
