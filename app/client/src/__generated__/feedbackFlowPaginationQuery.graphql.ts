...
export type feedbackFlowPaginationQuery$variables = {
  after?: string | null;
  first?: number | null;
  id: string;
};
export type feedbackFlowPaginationQuery$data = {
  readonly node: {
    readonly " $fragmentSpreads": FragmentRefs<"useLiveFeedbackPromptFlowsFragment">;
  } | null;
};
export type feedbackFlowPaginationQuery = {
  response: feedbackFlowPaginationQuery$data;
  variables: feedbackFlowPaginationQuery$variables;
};
