/**
 * @generated SignedSource<<90ca6e3423f249e39c67b63402624334>>
...
export type EventSidebarRefetchable$variables = {
  id: string;
};
export type EventSidebarRefetchableVariables = EventSidebarRefetchable$variables;
export type EventSidebarRefetchable$data = {
  readonly node: {
    readonly " $fragmentSpreads": FragmentRefs<"EventSidebarFragment">;
  } | null;
};
export type EventSidebarRefetchableResponse = EventSidebarRefetchable$data;
export type EventSidebarRefetchable = {
  variables: EventSidebarRefetchableVariables;
  response: EventSidebarRefetchable$data;
};
